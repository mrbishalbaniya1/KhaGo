...
export const mockOrders: Order[] = [
  { id: 'o1', tableNumber: 5, tokenNumber: 'A001', customerName: 'John Doe', products: [{ productId: 'p1', name: 'Chicken Momo', qty: 2, price: 250 }, { productId: 'p3', name: 'Vegetable Thukpa', qty: 1, price: 200 }], status: 'preparing', paymentMethod: 'pending', paymentStatus: 'pending', subtotal: 700.00, discount: 50, tip: 70, totalPrice: 720.00, createdAt: new Date(Date.now() - 3600000 * 1), notes: "Extra spicy on the momos" },
  { id: 'o2', tableNumber: 2, tokenNumber: 'A002', products: [{ productId: 'p2', name: 'Veg Chowmein', qty: 1, price: 180 }], status: 'pending', paymentMethod: 'pending', paymentStatus: 'pending', subtotal: 180.00, totalPrice: 180.00, createdAt: new Date(Date.now() - 3600000 * 0.5) },
  { id: 'o3', tableNumber: 8, tokenNumber: 'A003', customerName: 'Jane Smith', products: [{ productId: 'p6', name: 'Nepali Thali Set', qty: 1, price: 550 }, { productId: 'p4', name: 'Juju Dhau', qty: 1, price: 150 }], status: 'ready', paymentMethod: 'online', paymentStatus: 'paid', subtotal: 700.00, totalPrice: 700.00, createdAt: new Date(Date.now() - 3600000 * 2) },
  { id: 'o4', tableNumber: 3, tokenNumber: 'A004', products: [{ productId: 'p1', name: 'Chicken Momo', qty: 1, price: 250 }], status: 'delivered', paymentMethod: 'cash', paymentStatus: 'paid', subtotal: 250.00, totalPrice: 250.00, createdAt: new Date(Date.now() - 3600000 * 3) },
  { id: 'o5', tableNumber: 1, tokenNumber: 'A005', customerName: 'Alex Johnson', products: [{ productId: 'p5', name: 'Aloo Sandheko', qty: 2, price: 120 }], status: 'paid', paymentMethod: 'cash', paymentStatus: 'paid', subtotal: 240.00, tip: 20, totalPrice: 260.00, createdAt: new Date(Date.now() - 3600000 * 4) },
];
